...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php="http://php.net/xsl">
    ...
    <xsl:template match="html">
        <xsl:variable name="counter" select="php:function('Edutiek\AssessmentService\EssayTask\HtmlProcessing\Service::initParaCounter')" />
    ...
    <xsl:template match="body/h1|body/h2|body/h3|body/h4|body/h5|body/h6|body/p|body/ul|body/ol|body/pre">
        <xsl:variable name="counter" select="php:function('Edutiek\AssessmentService\EssayTask\HtmlProcessing\Service::nextParaCounter')" />
        <xsl:variable name="counterTag" select="php:function('Edutiek\AssessmentService\EssayTask\HtmlProcessing\Service::ParaCounterTag', local-name())" />
        <xsl:variable name="prefix" select="php:function('Edutiek\AssessmentService\EssayTask\HtmlProcessing\Service::nextHeadlinePrefix', local-name())" />
    ...
    <xsl:template name="words">
        <xsl:param name="text" />
        <xsl:variable name="para" select="php:function('Edutiek\AssessmentService\EssayTask\HtmlProcessing\Service::currentParaCounter')" />
        <xsl:for-each select="php:function('Edutiek\AssessmentService\EssayTask\HtmlProcessing\Service::splitWords', $text)/text()">
            <xsl:variable name="word" select="php:function('Edutiek\AssessmentService\EssayTask\HtmlProcessing\Service::nextWordCounter')" />
            <w-p>
